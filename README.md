...
> Note: Training parameters include a batch size of 128 and a training duration of 70 epochs. We evaluated the stability and effectiveness of our algorithm and comparison algorithms using 95% confidence intervals derived from 3 runs under different random seeds: 42, 2024, and 1010, respectively. All experimental results (e.g., training loss, test loss, and test accuracy) will be automatically saved as `.csv` files in the `./Neural_networks/results` directory.
...
> Note: Training parameters include a batch size of 128 and a training duration of 10 epochs. We evaluated the stability and effectiveness of our algorithm and comparison algorithms using 95% confidence intervals derived from 3 runs under different random seeds: 42, 2024, and 1010, respectively. All experimental results (e.g., training loss, top-1 test accuracy, and top-5 test accuracy) will be automatically saved as `.csv` files in the `./Neural_networks/results` directory.
